...
/* harmony import */ var _components_custom_bar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/custom-bar */ "./src/js/components/custom-bar.js");
/* harmony import */ var _components_swiper_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/swiper-slider */ "./src/js/components/swiper-slider.js");
...
/* harmony import */ var _components_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/mask */ "./src/js/components/mask.js");
/* harmony import */ var _components_mask__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_mask__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _functions_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/filter */ "./src/js/functions/filter.js");
/* harmony import */ var _functions_filter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_functions_filter__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/fslightbox/index.js */ "./node_modules/fslightbox/index.js");
/* harmony import */ var _node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_fslightbox_index_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _node_modules_swiper_modules_grid_grid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/swiper/modules/grid/grid */ "./node_modules/swiper/modules/grid/grid.js");
/* harmony import */ var _node_modules_inputmask_dist_inputmask_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../node_modules/inputmask/dist/inputmask.min.js */ "./node_modules/inputmask/dist/inputmask.min.js");
/* harmony import */ var _node_modules_inputmask_dist_inputmask_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_node_modules_inputmask_dist_inputmask_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./src/js/components/custom-bar.js":
/*!*****************************************!*\
  !*** ./src/js/components/custom-bar.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_0__.Grid]);
const readysSlider = document.querySelectorAll('.ready-slider');
const reviewsSlider = document.querySelector('.reviews-slider');
const reviewsModals = document.querySelector('.reviews-modal');
const reviewsModalsTabs = document.querySelector('.reviews-modal-thumbs');
const catalogSliders = document.querySelectorAll('.catalog-slider');
const productModals = document.querySelector('.product-slider');
const productModalsTabs = document.querySelector('.product-slider-thumbs');
const othersSlider = document.querySelector('.other-slider');
if (readysSlider) {
  readysSlider.forEach(el => {
    let readySlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      slidesPerView: 2,
      spaceBetween: 30,
      lazy: true,
      navigation: {
        nextEl: el.querySelector('.ready-slider__next'),
        prevEl: el.querySelector('.ready-slider__prev')
      },
      pagination: {
        el: el.querySelector('.ready-slider__pag'),
        type: 'bullets',
        clickable: true
      },
      breakpoints: {
...
;
if (reviewsSlider) {
  const reviewSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsSlider, {
    slidesPerView: 2,
    spaceBetween: 30,
    lazy: true,
    navigation: {
...
;
if (reviewsModals) {
  const reviewsModalsTab = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsModalsTabs, {
    slidesPerView: 4,
    spaceBetween: 16,
    lazy: true,
    freeMode: true,
  ...
  const reviewsModal = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsModals, {
    spaceBetween: 20,
    thumbs: {
      swiper: reviewsModalsTab
    },
    navigation: {
      nextEl: '.reviews-modal__next',
      prevEl: '.reviews-modal__prev'
    },
    pagination: {
      el: '.reviews-modal__pag',
      type: 'bullets',
      clickable: true
    }
  });
...
;
if (catalogSliders) {
  catalogSliders.forEach(el => {
    let catalogSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      slidesPerView: 1,
      spaceBetween: 20,
      grid: {
        rows: 4,
...
;
if (productModals) {
  const productModalsTab = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](productModalsTabs, {
    slidesPerView: 4,
  ...
  const productModal = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](productModals, {
    spaceBetween: 20,
    //     // slidesPerView: 1,
    //     // // direction: "horizontal",
    thumbs: {
      swiper: productModalsTab
    }
    //     // breakpoints: {
    //     //   320: {
    //     //     // direction: "horizontal",
...
;
if (othersSlider) {
  const otherSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](othersSlider, {
    slidesPerView: 2,
    spaceBetween: 30,
    lazy: true,
    navigation: {
      nextEl: '.ready-slider__next',
      prevEl: '.ready-slider__prev'
    },
    pagination: {
      el: '.ready-slider__pag',
      type: 'bullets',
      clickable: true
    },
    breakpoints: {
...
if (document.querySelector('.ideas')) {
  const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('ideas');
}
if (document.querySelector('.ready')) {
  const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('ready');
}
if (document.querySelector('.catalog')) {
  const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('catalog');
}
if (document.querySelector('.product-tabs')) {
  const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('product-tabs');
}
...
(function () {
  ...
  const filterMenu = document?.querySelector('[data-filtermenu]');
  const filterMenuItems = document?.querySelectorAll('[data-filterMenu-item]');
  const overlay = document?.querySelector('[data-filtermenu-overlay]');
  filter?.addEventListener('click', e => {
    filter?.classList.toggle('filter--active');
    filterMenu?.classList.toggle('filterMenu--active');
    if (filterMenu?.classList.contains('filterMenu--active')) {
      filter?.setAttribute('aria-expanded', 'true');
      filter?.setAttribute('aria-label', 'Закрыть фильтр');
    } else {
      filter?.setAttribute('aria-expanded', 'false');
      filter?.setAttribute('aria-label', 'Открыть фильтр');
    }
  });
  overlay?.addEventListener('click', () => {
    filter?.setAttribute('aria-expanded', 'false');
